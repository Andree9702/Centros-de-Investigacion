# 📄 Propuesta de Creación del Centro de Investigación - FCQS
...
- La FCQS cuenta con [X] docentes con dedicación a tiempo completo
- [X] investigadores están acreditados por SENESCYT
- El IPPC promedio de la facultad es [X.XX]
- Tradición de investigación en laboratorios especializados
...
## 4. LÍNEAS DE INVESTIGACIÓN PROPUESTAS

| # | Línea de Investigación | Descripción |
|---|------------------------|-------------|
| 1 | Química Analítica y de Productos Naturales | Caracterización de compuestos, fitoquímica |
| 2 | Farmacología y Toxicología | Desarrollo de fármacos, estudios preclínicos |
| 3 | Bioquímica Clínica | Marcadores, diagnóstico, biotecnología |
| 4 | Salud Pública y Epidemiología | Estudios poblacionales, enfermedades prevalentes |
| 5 | Enfermería Basada en Evidencia | Protocolos, cuidados, gestión hospitalaria |

---

## 5. MASA CRÍTICA DE INVESTIGADORES

*[PENDIENTE: Completar con resultados del análisis IPPC]*

### 5.1. Resumen de Indicadores

| Indicador | Valor |
|-----------|-------|
| Total de docentes propuestos | [PENDIENTE] |
| Docentes con doctorado (PhD) | [PENDIENTE] |
| Investigadores acreditados SENESCYT | [PENDIENTE] |
| IPPC promedio del grupo | [PENDIENTE] |
| Investigadores Cluster A (Élite) | [PENDIENTE] |
| Índice de Masa Crítica (IMC) | [PENDIENTE] |

---

## 6. INFRAESTRUCTURA EXISTENTE

La FCQS cuenta con infraestructura de laboratorios que puede aprovecharse:

| Laboratorio | Equipamiento Destacado |
|-------------|------------------------|
| Laboratorio de Química Analítica | HPLC, espectrofotómetros |
| Laboratorio de Farmacología | Equipos de ensayo biológico |
| Laboratorio de Microbiología | Cabinas de bioseguridad, incubadoras |
| Laboratorio de Bioquímica | Centrífugas, analizadores |
